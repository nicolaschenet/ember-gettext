(function(window) {
  ...
  var EmHandlebars = Ember.Handlebars;
  ...
  EmHandlebars.registerBoundHelper('_t', function (msgid, context) {
    return new EmHandlebars.SafeString(Ember.I18n._t(msgid, context.hash));
  });

  // register _n template operator for plurals
  EmHandlebars.registerBoundHelper('_n', function (msgid, msgid_plural, context) {
    return new EmHandlebars.SafeString(Ember.I18n._n(msgid, msgid_plural, context.hash));
  });
}).call(undefined, this);
